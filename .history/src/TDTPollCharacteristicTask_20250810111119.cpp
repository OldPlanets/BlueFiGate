...
TDTPollCharacteristicTask::TDTBMSData TDTPollCharacteristicTask::getBMSDataFromResultTaskResult(const TaskResult result)
{
    TDTBMSData bmsData;
...
TDTPollCharacteristicTask::TDTBMSData TDTPollCharacteristicTask::parseTDTData()
{
    TDTBMSData bmsData = {};
