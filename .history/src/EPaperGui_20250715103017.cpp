...
void EPaperGui::drawNewLayout() {
    ...
    int iconAreaWidth = 50;  // Space for icons on the left
    ...
    drawCenteredText("IN", insideX, 15, valueAreaWidth, &FreeSans9pt7b);
    drawCenteredText("OUT", outsideX, 15, valueAreaWidth, &FreeSans9pt7b);
