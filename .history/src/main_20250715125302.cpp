...
void setup()
{
    ...
    EPaperGui gui;
    gui.setTemperatureInside(22.5);
    gui.setTemperatureOutside(18.3);
    gui.setHumidityInside(45);
    gui.setHumidityOutside(62);
    gui.setBatteryInside(85);
    gui.setBatteryOutside(10);
