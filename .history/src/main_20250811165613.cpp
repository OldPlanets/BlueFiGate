...
void setup()
{
    ...
    if (bCrashedBefore)
    {
        ledColor(128, 0, 0, 1000 * 300);
    }
    else
    {
        ledColor(128, 128, 0, 0);
    }
...
void loop()
{
    ...
    if (batteryManager.getLastTdtUpdateMs() > 0 && bStartedUpSucceededNotification && !bCrashedBefore)
    {
        bStartedUpSucceededNotification = false;
        ledColor(0, 255, 0, 1000 * 10);
    }
